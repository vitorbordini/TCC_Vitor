...
class MICCAIBraTS2018(Dataset):
    ...
    def __init__(self, args, mode, dataset_path='/content/drive/MyDrive/2020-12-BRICS/BRATS-2020/', classes=5, crop_dim=(32, 32, 32), split_idx=10,
                 samples=10,
                 load=False):
        """
        ...
        self.testing_path = self.root + 'MICCAI_BraTS2020_TrainingData/'
        self.CLASSES = 4
